// Change Log
// 0.2.1 - Modified revealPassword to allow selection of any input type text instead of just password - Ismael Goncalves - i.goncalves@f5.com, line 267
...
function init(jQuery) {
	...
	var receivingDomain = location.protocol + "//f5-tests.com";
	...
	registerButton("Check F5 Components", checkComponents, "May not be compatible with old versions of vTrack");
